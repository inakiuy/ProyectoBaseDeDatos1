...
class gsp_proyectoBaseDeDatos1_roleshow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("role.description.label"),'default':("Description")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(roleInstance),'field':("description")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (roleInstance?.name)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("role.name.label"),'default':("Name")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(roleInstance),'field':("name")],-1)
printHtmlPart(16)
}
printHtmlPart(20)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1541892745950L
