	...
	<body>
		...
		<div id="show-permission" class="content scaffold-show" role="main">
			...
			<ol class="property-list permission">
				...
				<g:if test="${permissionInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="permission.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${permissionInstance}" field="description"/></span>
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="permission.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${permissionInstance}" field="name"/></span>
