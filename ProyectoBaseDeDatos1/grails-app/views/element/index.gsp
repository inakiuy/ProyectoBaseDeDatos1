		...
		<div id="list-element" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'element.description.label', default: 'Description')}" />
				...
				<g:each in="${elementInstanceList}" status="i" var="elementInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${elementInstance.id}">${fieldValue(bean: elementInstance, field: "description")}</g:link></td>
